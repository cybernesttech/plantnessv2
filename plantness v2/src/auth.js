...
async function _resolveRoleAndBusiness(firebaseUser) {
  ...
  // ── First sign-in — create user and business documents ────────────────
  // New users are owners by default (they signed up themselves).
  ...
  console.log('[auth._resolveRoleAndBusiness] first sign-in — creating owner', { uid, email });
